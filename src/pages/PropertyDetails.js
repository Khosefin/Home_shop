  ...
  return (
    ...
    mb-14"
      >
        ...
        <div className="flex flex-row items-start gap-8 lg:flex-row">
          ...
          <div className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8">
            ...
            <form className="flex flex-col gap-y-4">
              <input
                className="border border-gray-300 focus:borderv700 outline-none rounded w-full px-4 h-14 text-sm"
                type="text"
                placeholder="Name"
              />
              <input
              ...
              />
              <textarea
                className="border border-gray-300 focus:bg-violet-700 outline-none resize-none rounded w-full p-4 h-36 text-sm text-gray-400"
                placeholder="Message"
              ></textarea>
